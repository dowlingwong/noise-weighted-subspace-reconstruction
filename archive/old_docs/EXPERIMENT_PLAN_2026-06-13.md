# Archived Experiment Plan for the Unified ML Framework Paper

> Archived on 2026-06-18. This plan reflects the earlier DELight/K-alpha,
> P0/P1, E/G, and Block 11/12 validation program. Durable scientific cautions
> were consolidated into `docs/VALIDATION_ROADMAP.md`.
...
needed before circulation / submission. The current external-data policy is in
[README.md - Data Root](../../README.md#data-root).
