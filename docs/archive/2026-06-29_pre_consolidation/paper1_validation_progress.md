...
- **GWOSC waveform and follow-up diagnostics**: the approximate chirp has been
  replaced by the checksummed public GW150914 numerical-simulation waveform.
  Predeclared shared-FIR equivalence and global-versus-local PSD experiments
  are implemented and awaiting a controlled remote evidence run; see
  [`GWOSC_FILTERING_AND_LOCAL_PSD_PROTOCOL.md`](GWOSC_FILTERING_AND_LOCAL_PSD_PROTOCOL.md).
